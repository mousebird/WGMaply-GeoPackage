...
- (id)initWithGeoPackage:(GPKGGeoPackage *)geoPackage tableName:(NSString *)inTableName bounds:(NSDictionary *)bounds {
    ...
    self = [super initWithName:tableName minZoom:_tileDao.minZoom+zoomOffset maxZoom:_tileDao.maxZoom+zoomOffset];
